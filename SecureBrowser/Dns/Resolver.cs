...
namespace SecureBrowser.DNS
{
	...
	public class Resolver
	{
		...
		///		An System.IAsyncResult instance returned by a call to the SecureBrowser.Dns.Resolver.BeginGetHostAddresses(System.String,System.AsyncCallback,System.Object)
		///		method.
		/// </param>
		/// <returns></returns>
		...
		///		SecureBrowser.Dns.Resolver.BeginGetHostByName method.
		/// </param>
		/// <returns></returns>
		...
		/// <param name="AsyncResult">
		///		An System.IAsyncResult instance returned by a call to an 
		///		Overload:SecureBrowser.Dns.Resolver.BeginGetHostEntry method.
		/// </param>
		/// <returns>
		///		An System.Net.IPHostEntry instance that contains address information about
		///		the host. 
